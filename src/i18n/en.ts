...
export const en = {
    ...
    // Review mode
    codelens_review: "🔄 Redo",
    codelens_restore: "↩️ Restore",
    codelens_mastered: "✅ Mastered",
    codelens_unmastered: "⬜ Mark Mastered",
    review_started: "Redo mode started. Code template reset. Write your solution and submit.",
    review_backup_not_found: "No backup found. Was redo mode started?",
    review_restored: "Code restored from backup.",
    review_cleared: "Code reset for redo.",
